...
// `pidgin_agent::harness::system_prompt`. pi's `Skill[]` crosses as a JSON
...
import { formatSkillsForSystemPrompt as nativeFormatSkillsForSystemPrompt } from "pidgin-napi";
