// Native shim for packages/ai/src/auth/oauth/device-code.ts, backed by the atilla
// Rust addon (`atilla-napi`). Installed by conformance/codegen.mjs when the module
...
// `DeviceCodePollMachine` (`atilla_ai::auth::oauth::device_code`). The Rust machine
...
import { driveDevicePoll } from "atilla-napi/oauth-flow-driver.js";
