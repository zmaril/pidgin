// Native shim for packages/coding-agent/src/utils/ansi.ts, backed by the pidgin
...
//
// Scope of the native flip: `stripAnsi`, ported to `pidgin_coding::utils::ansi`.
...
import { stripAnsi as nativeStripAnsi } from "pidgin-napi";
