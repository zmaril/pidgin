// Native shim for packages/coding-agent/src/utils/git.ts, backed by the pidgin
...
// `pidgin_coding::utils::git_url`. The native function returns pi's exact
...
import { parseGitUrl as nativeParseGitUrl } from "pidgin-napi";
