// Native shim for packages/coding-agent/src/utils/mime.ts, backed by the pidgin
...
// ported to `pidgin_coding::utils::mime`. pi's file-reading wrapper
...
import { detectSupportedImageMimeType as nativeDetectSupportedImageMimeType } from "pidgin-napi";
