//! Offline interactive `atilla` session with a canned (faux) assistant turn.
//!
...
//!
//! ```sh
//! cargo run -p atilla-coding --example interactive_faux
//! ```

use std::io::stdout;

use atilla_coding::modes::interactive::InteractiveShell;
use atilla_tui::ProcessTerminal;
