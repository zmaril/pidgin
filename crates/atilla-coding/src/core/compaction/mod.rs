// straitjacket-allow-file:duplication — faithful-mirror pair with crates/atilla-agent/src/harness/compaction (agent-core copy); parallel structure is intentional
...
//! (`crates/atilla-agent/src/harness/compaction/`) does. That entry-expansion is
...
//! which atilla-ai does not yet wrap; see [`compaction`] for the rationale.
