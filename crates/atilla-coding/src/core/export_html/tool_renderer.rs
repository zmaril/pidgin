...
//! That depends on the pi-tui port (atilla-tui), which a sibling owns and which is
...
/// until atilla-tui lands) invokes a tool's TUI renderer and converts the ANSI
/// output to HTML.
