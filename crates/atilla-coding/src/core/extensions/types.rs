...
//! reuses [`atilla_agent::types`] wholesale — [`AgentToolResult`],
//! [`AgentToolUpdateCallback`], and [`ToolExecutionMode`] — rather than
//! re-porting them, and mirrors [`atilla_agent::types::AgentTool`]'s field and
...
use atilla_agent::types::{AgentToolResult, AgentToolUpdateCallback, ToolExecutionMode};
...
/// [`atilla_agent::types::PrepareArguments`] (which borrows); the extension
...
///
/// This mirrors [`atilla_agent::types::AgentToolExecute`] exactly — the
...
///
/// A superset of [`atilla_agent::types::AgentTool`]: the same metadata and
