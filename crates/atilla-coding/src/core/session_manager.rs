...
//!
//! # Why this is not `atilla_agent`'s session layer
//!
//! `atilla_agent::harness::session` mirrors pi's *agent-core* v3 schema
...
use atilla_agent::harness::types::{ModelRef, SessionError};
...
pub use atilla_agent::harness::types::{
