...
//! (`AssistantMessageComponent`). Composes `atilla-tui`'s `Container`,
...
use atilla_tui::{DefaultTextStyle, Markdown, Spacer, Text};

use atilla_ai::types::{AssistantMessage as AiAssistantMessage, ContentBlock, StopReason};
