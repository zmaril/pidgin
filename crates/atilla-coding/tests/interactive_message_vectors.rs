...
// the atilla-tui vector-test binaries use (widget_vectors.rs etc.); each
...
//! pi itself (`crates/atilla-coding/vectors/gen/generate_interactive_messages.mjs`).
...
use atilla_coding::core::extensions::types::{RenderShell, ToolDefinition};
use atilla_coding::modes::interactive::components::{
