...
use atilla_ai::providers::faux::{faux_assistant_message, faux_text, FauxAssistantOptions};
use atilla_ai::types::ContentBlock;
use atilla_coding::modes::interactive::routing::{ChatRegion, ChatState};
use atilla_coding::modes::interactive::theme::{create_theme, parse_theme_json, ColorMode, Theme};
use atilla_coding::modes::interactive::turn::collect_faux_turn;
use atilla_coding::modes::interactive::{InteractiveShell, ShellEvent};
use atilla_tui::renderer::Component;
use atilla_tui::{ProcessTerminal, Terminal};
...
fn routing_streams_an_assistant_message_start_update_end() {
    ...
    state.handle_event(&AgentEvent::MessageUpdate {
        ...
        assistant_message_event: Box::new(atilla_ai::AssistantMessageEvent::TextDelta {
