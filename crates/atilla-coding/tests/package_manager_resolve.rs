...
use atilla_coding::core::package_manager::{ResolvedResource, ScopeResources};
use atilla_coding::core::source_info::SourceScope;
use serde_json::json;
...
fn returns_no_package_paths_when_no_sources_configured() {
    ...
    assert!(result.skills.iter().all(|r| r.metadata.source == "auto"
        && r.metadata.origin == atilla_coding::core::source_info::SourceOrigin::TopLevel));
}
