...
use atilla_ai::auth::oauth::extension::{
...
use atilla_coding::core::extensions::runner::ExtensionRunner as RunnerTrait;
...
async fn load_fixture() -> (Arc<JsPlaneHandle>, atilla_extensions::Inventory) {
