...
//!
//! # Why they live here (and not in atilla-coding)
//!
//! These MOVED out of `crates/atilla-coding/tests/resource_loader_orchestrator.rs`
//! (where they were `#[ignore]`'d behind `StubExtensionLoader`). The real
//! `impl ExtensionLoader` lives in atilla-extensions — which depends on
//! atilla-coding and needs V8 — so an atilla-coding test cannot reference it
...
//! (e.g. `custom_extension_loader_is_held`) stays in atilla-coding's default
//! V8-free suite.
//!
