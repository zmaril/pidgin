...
use atilla_coding::core::extensions::command::ResolvedCommand;
use atilla_coding::core::extensions::events::agent::AgentStartEvent;
use atilla_coding::core::extensions::events::common::BuildSystemPromptOptions;
use atilla_coding::core::extensions::events::session::{
...
async fn bind_core_binds_hosts_and_mints_a_command_context() {
    ...
    runner.emit_error(atilla_coding::core::extensions::dispatch::ExtensionError {
...
impl SessionControlHost for MockControlHost {
    ...
    fn get_thinking_level(&self) -> atilla_agent::types::ThinkingLevel {
        atilla_agent::types::ThinkingLevel::Off
    }
    fn set_thinking_level(&self, _level: atilla_agent::types::ThinkingLevel) {}
}
...
impl SessionContextHost for MockContextHost {
    ...
    fn get_signal(&self) -> atilla_ai::seams::AbortSignal {
        atilla_ai::seams::AbortSignal::new()
    }
    fn abort(&self) {}
