...
//! ([`atilla_coding::core::tools`]) to completion and returns the pi-shaped
...
use atilla_coding::core::tools::bash::{create_local_bash_operations, BashTool, BashToolDetails};
use atilla_coding::core::tools::ls::{create_local_ls_operations, run_ls, LsParams};
use atilla_coding::core::tools::truncate::{TruncatedBy, TruncationResult};
use atilla_coding::core::tools::write::{create_local_write_operations, run_write, WriteParams};
...
static RUNTIME: LazyLock<tokio::runtime::Runtime> = LazyLock::new(|| {
    tokio::runtime::Builder::new_multi_thread()
        .enable_all()
        .build()
        .expect("failed to build the atilla-napi tools runtime")
});
