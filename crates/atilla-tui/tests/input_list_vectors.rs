...
//! (`crates/atilla-tui/vectors/gen/generate_input_lists.mjs`). Every assertion
...
use atilla_tui::components::input::Input;
use atilla_tui::components::select_list::{
    SelectItem, SelectList, SelectListLayoutOptions, SelectListTheme,
    SelectListTruncatePrimaryContext, TruncatePrimaryFn,
};
use atilla_tui::components::settings_list::{
