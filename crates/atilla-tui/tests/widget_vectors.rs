...
//! (`crates/atilla-tui/vectors/gen/generate_widgets.mjs`). Every assertion is
...
use atilla_tui::widgets::image::{Image, ImageOptions, ImageTheme};
use atilla_tui::widgets::loader::{Loader, LoaderIndicatorOptions};
use atilla_tui::widgets::spacer::Spacer;
use atilla_tui::widgets::text::{BgFn, Text};
use atilla_tui::widgets::truncated_text::TruncatedText;
