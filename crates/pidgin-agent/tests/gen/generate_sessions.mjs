...
//
// Run from anywhere:  node crates/pidgin-agent/tests/gen/generate_sessions.mjs
//
// Outputs:
//   crates/pidgin-agent/tests/fixtures/v3-pi-generated.jsonl
//   crates/pidgin-coding/tests/fixtures/v3-pi-coding-generated.jsonl
// and prints a structural DIFF against the hand-authored
//   crates/pidgin-agent/tests/fixtures/v3-all-line-types.jsonl
...
const repoRoot = join(here, "..", "..", "..", ".."); // crates/pidgin-agent/tests/gen -> repo root
...
// Run.
// ---------------------------------------------------------------------------
const agentOut = join(repoRoot, "crates/pidgin-agent/tests/fixtures/v3-pi-generated.jsonl");
const codingOut = join(repoRoot, "crates/pidgin-coding/tests/fixtures/v3-pi-coding-generated.jsonl");
...
const handAuthored = readFileSync(join(repoRoot, "crates/pidgin-agent/tests/fixtures/v3-all-line-types.jsonl"), "utf8");
