...
/// Convert an pidgin-ai [`Context`] into the OpenAI Chat Completions
...
/// Convert pidgin-ai tools to the OpenAI `{type:"function", function:{...}}`
...
/// Map an OpenAI chunk `usage` object to pidgin-ai [`Usage`] + cost, mirroring
