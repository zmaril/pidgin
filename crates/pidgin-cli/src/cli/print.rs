...
//! ([`pidgin_coding::modes::print::provider_stream`]). No native HTTP transport
...
use pidgin_coding::core::model_resolver::{
    find_initial_model, resolve_cli_model, FindInitialModelOptions, ModelRuntimeView,
    ResolveCliModelOptions,
};
use pidgin_coding::core::model_runtime::{CreateModelRuntimeOptions, ModelRuntime};
use pidgin_coding::core::session_manager::SessionManager;
use pidgin_coding::core::settings_manager::SettingsManager;
use pidgin_coding::core::skills::get_agent_dir;
use pidgin_coding::modes::print::{
    build_harness, builtin_models_registry, run_print_mode, PrintModeOptions, PrintOutputMode,
};
use pidgin_core::ai::types::Model;
