...
//! messages.ts`, not in `compaction/utils.ts`. pidgin-coding has not ported that
...
//! a shared `pidgin_coding::core::messages` module.

use std::collections::BTreeSet;

use serde_json::Value;

use pidgin_ai::{AssistantMessage, ContentBlock};
...
/// already tracks. pidgin-coding has no extension engine yet; the guard is
...
// until pidgin-coding ports a shared `messages` module. Mirrors pi's
