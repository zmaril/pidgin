...
//!
//! **The stateful network overlay is deferred.** pidgin-ai's [`RegistryProvider`]
...
//! client itself is also unported (see `crates/pidgin-ai` builtins, which route
...
//! When pidgin-ai lands a store-and-network-aware refresh hook, the wrapper can
