...
//! pidgin's tool files hold only the **pure** ported layers (`format_text_read`,
...
//! `is_error` tool result. pidgin's [`pidgin_agent::types::AgentToolExecute`]
...
use pidgin_agent::types::{AgentToolResult, AgentToolUpdateCallback};
