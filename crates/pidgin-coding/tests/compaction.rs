...
// (crates/pidgin-agent/tests/compaction.rs) is intentional.
...
//! `completeSimple` (pidgin-ai does not yet wrap `Models`); it records the
...
use pidgin_coding::core::compaction::{
