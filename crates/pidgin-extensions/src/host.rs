//! Lowering the JS [`Inventory`] onto pidgin-coding's registration surface.
//!
...
//! stand in.
//!
//! Tool lowering defers with it: an pidgin-coding
//! [`ToolDefinition`](pidgin_coding::core::extensions::types::ToolDefinition)
...
use pidgin_coding::core::extensions::command::{Command, CommandContext};
use pidgin_coding::core::extensions::events::ExtensionEvent;
use pidgin_coding::core::extensions::hook::{Hook, HookEvent, HookOutcome};
...
mod tests {
    ...
    use pidgin_coding::core::extensions::registry::Registry;
    use serde_json::json;
