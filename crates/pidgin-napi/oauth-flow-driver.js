// Shared JS driver loop for the OAuth conformance shims, backed by the pidgin
// Rust addon (`pidgin-napi`). The four provider shims (anthropic, openai-codex,
...
//
// The boundary is one-way (see crates/pidgin-napi/src/oauth.rs): the Rust
...
// the `vendor/pi/node_modules/pidgin-napi -> crates/pidgin-napi` symlink the
