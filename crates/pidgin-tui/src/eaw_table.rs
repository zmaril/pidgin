...
// Regenerate via crates/pidgin-tui/vectors/gen/gen_eaw_table.sh.
// Merged FullWidth + Wide codepoint ranges. eastAsianWidth(cp) returns 2 iff
// cp falls in one of these ranges (isFullWidth || isWide), else 1. Ambiguous,
// Halfwidth, Narrow and Neutral are all width 1 because pi calls the library
// with the default ambiguousAsWide = false.

pub(crate) const WIDE_OR_FULLWIDTH_RANGES: &[(u32, u32)] = &[
    (0x1100, 0x115F),
    (0x231A, 0x231B),
    (0x2329, 0x232A),
    (0x23E9, 0x23EC),
