// Vendored verbatim from earendil-works/pi:
//   packages/coding-agent/examples/extensions/pirate.ts
// MIT License © 2025 Mario Zechner. See examples/extensions/NOTICE.
// A canonical pi example: a /pirate slash command toggles a flag that a
// before_agent_start hook reads to append pirate-speak to the system prompt.
/**
 * Pirate Extension
 *
