...
// upstream: packages/coding-agent/examples/extensions/reload-runtime.ts
// Vendored verbatim; needs the typebox module loader (its `import { Type } from
// "typebox"` is a value import that survives transpile and must resolve).
