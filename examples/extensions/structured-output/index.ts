...
// upstream: packages/coding-agent/examples/extensions/structured-output.ts
// Vendored verbatim; needs the pi-tui render-stub + pi-ai/pi-coding-agent shims
// + the typebox module loader (its `Text`/`defineTool`/`Type` value imports must
// resolve at load time; `Text` is used only in the display-time renderResult).
