...
6. **Upstream TS→Rust porting notes.** The upstream TS→Rust porting notes are being relocated into `notes/` (as `notes/startup/ts-to-rust.md`) by the transpilation workstream; reconcile this plan with them once landed.
